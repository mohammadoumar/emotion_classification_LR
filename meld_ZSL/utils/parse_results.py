...
with open(os.path.join(RESULTS_DIR, 'zs_classification_reports.json'), 'w') as json_file:
    json.dump(all_reports, json_file, indent=4)

print("Classification reports have been successfully dumped into 'zs_classification_reports.json'")
