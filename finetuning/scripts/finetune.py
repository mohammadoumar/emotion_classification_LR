...
if not os.path.exists(os.path.join(FT_DIR, "finetuning_model_args")):
    os.mkdir(os.path.join(FT_DIR, "finetuning_model_args"))

train_file = os.path.join(FT_DIR, "finetuning_model_args", f"""{train_dataset_name.split(".")[0].split("train")[0]}{BASE_MODEL.split("/")[1]}.json""")
